      ...
      <main className="relative z-10 w-full pt-32 pb-24">
        <article className="mx-auto w-[min(100%,72rem)] px-4 sm:px-6 lg:px-10 xl:px-12 space-y-8">
          ...
          <div className="w-full max-w-none space-y-10 text-[#8aac78] text-lg md:text-xl leading-[1.9]">
            ...
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">My Roadmap</h2>
            <table className="w-full border-collapse my-6">
              <thead>
                <tr className="border-b border-[#8aac78]/30">
                  <th className="text-left py-3 px-4 text-[#c4d4b8] font-semibold">Year, Semester</th>
                  <th className="text-left py-3 px-4 text-[#c4d4b8] font-semibold">Courses</th>
              ...
              <tbody>
                ...
                <tr className="border-b border-[#8aac78]/20 hover:bg-white/[0.03] transition-colors">
                  <td className="py-3 px-4 text-[#c4d4b8]">Year 1, Fall</td>
                  <td className="py-3 px-4 text-[#c4d4b8]">Chinese: ASIALANG101</td>
                  <td className="py-3 px-4 text-[#c4d4b8]">International Business: INTLBUS200</td>
                  <td className="py-3 px-4 text-[#c4d4b8]">Programming I: CS200</td>
                  <td className="py-3 px-4 text-[#c4d4b8]">Critical Thinking and Expression: ILS200</td>
                  <td className="py-3 px-4 text-[#c4d4b8]">Calculus 2: MATH222</td>
                </tr>
                <tr className="border-b border-[#8aac78]/20 hover:bg-white/[0.03] transition-colors">
                  <td className="py-3 px-4 text-[#c4d4b8]">Year 1, Spring</td>
                   <td className="py-3 px-4 text-[#c4d4b8]">Computer Engineering: CS252</td>
                  <td className="py-3 px-4 text-[#c4d4b8]">Programming II: CS300</td>
                  <td className="py-3 px-4 text-[#c4d4b8]">Linear Algebra: MATH340</td>
                  <td className="py-3 px-4 text-[#c4d4b8]">Biological Anthropology: ANTHRO105</td>
                  <td className="py-3 px-4 text-[#c4d4b8]">Afro Asian Improv: DANCE319</td>
                  <td className="py-3 px-4 text-[#c4d4b8]">Insects and Human Culture: ENTOM201</td>
                </tr>
                <tr className="border-b border-[#8aac78]/20 hover:bg-white/[0.03] transition-colors">
                  <td className="py-3 px-4 text-[#c4d4b8]">Year 1, Summer</td>
                   <td className="py-3 px-4 text-[#c4d4b8]">Discrete Mathematics: CS240</td>
                  <td className="py-3 px-4 text-[#c4d4b8]">Artificial Intelligence: CS540</td>
                  <td className="py-3 px-4 text-[#c4d4b8]">Programming III: CS400</td>
                </tr>
                

                <tr className="border-b border-[#8aac78]/20 hover:bg-white/[0.03] transition-colors">
                  <td className="py-3 px-4 text-[#c4d4b8]">Year 2, Fall</td>
                   <td className="py-3 px-4 text-[#c4d4b8]">Machine Organization and Programming: CS354</td>
                  <td className="py-3 px-4 text-[#c4d4b8]">Algorithms: CS577</td>
                  <td className="py-3 px-4 text-[#c4d4b8]">Theater and Dramatic Literature: ENGL120</td>
                  <td className="py-3 px-4 text-[#c4d4b8]">Combinatorics: CS475</td>
                </tr>

                

                <tr className="border-b border-[#8aac78]/20 hover:bg-white/[0.03] transition-colors">
                  <td className="py-3 px-4 text-[#c4d4b8]">Year 2, Spring</td>
                   <td className="py-3 px-4 text-[#c4d4b8]">Theory of Computing: CS520</td>
                  <td className="py-3 px-4 text-[#c4d4b8]">Optimization: CS524</td>
                  <td className="py-3 px-4 text-[#c4d4b8]">Big Data Systems: CS544</td>
                  <td className="py-3 px-4 text-[#c4d4b8]">Operating Systems: CS537</td>
                </tr>

                <tr className="border-b border-[#8aac78]/20 hover:bg-white/[0.03] transition-colors">
                  <td className="py-3 px-4 text-[#c4d4b8]">Year 3, Fall</td>
                   <td className="py-3 px-4 text-[#c4d4b8]">R for Statistics I: STAT303</td>
                  <td className="py-3 px-4 text-[#c4d4b8]">Databases: CS564</td>
                  <td className="py-3 px-4 text-[#c4d4b8]">Calculus 3: MATH234</td>
                </tr>
